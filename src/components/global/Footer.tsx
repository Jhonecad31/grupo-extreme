      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
          <div className="md:col-span-4">
            <Link href={lang === "es" ? "/" : `/${lang}`} className="block mb-8 group">
              <div className="relative w-48 h-16 transition-transform duration-300 group-hover:scale-105">
                <Image
                  src="/icon/logos/logo-extreme-negativo.svg"
            ...
            <div className="flex space-x-4">
              {[
                ...
                <Link key={social.name} href={social.href} className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-primary hover:bg-primary transition-all duration-300">
          ...
          <div className="md:col-span-2 md:col-start-6">
            ...
            <ul className="space-y-4">
              {[
                { name: dict.navigation.home, href: lang === "es" ? "/" : `/${lang}` },
                { name: dict.navigation.projects, href: lang === "es" ? "/projects" : `/${lang}/projects` },
                { name: dict.navigation.about, href: lang === "es" ? "/about" : `/${lang}/about` },
                { name: dict.navigation.blog, href: lang === "es" ? "/blog" : `/${lang}/blog` },
                { name: dict.navigation.contact, href: lang === "es" ? "/contact" : `/${lang}/contact` }
              ].map((item) => (
                <li key={item.name}>
